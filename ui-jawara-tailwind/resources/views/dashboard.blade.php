...
<body>
    ...
    {{-- HERO --}}
    <div class="relative grid t-20 h-dvh w-dvh bg-bg-hero rounded-t-3xl z-10">

        {{-- Header --}}
        <div class="absolute rounded-t-3xl top-0 left-0 right-0 h-28 flex justify-between items-center">

            {{-- PROFILE --}}
            <div class="flex items-start space-x-2 text-gray-300 mx-7 my-12">

                {{-- LOGO PROFILE --}}
                <div class="ml-2 mr-2 w-14 h-13 rounded-full overflow-hidden">
                    <img src="{{ asset('img/logo-profile.jfif') }}" alt="Profile Picture"
                        class="w-full h-full object-cover">
                </div>
                {{-- LOGO PROFILE --}}
        ...
        <div class="flex gap-4 bg-gradient-to-b from-bg-hero via-bg-button to to-blue-500">
            {{-- Tabel Dashboard --}}
